...
(1, 'assets/img/favicons/favicon.png', 'assets/img/illustrations/banner.jpg', 'Hệ Thống Dịch Vụ Mạng Xã Hội Facebook, TikTok, Instagram,...', 'Hệ Thống Dịch Vụ Mạng Xã Hội Facebook | Youtube | Instagram | TikTok ', '', 'Ngọc Hiếu', '0867690867', '', 'null', 'DO NGOC HIEU', 'MB Bank', '9999258999999', '', 'DO NGOC HIEU', 'NULL', 'OFF', 'HO CHI MINH', 'naptien');
...
(53, 'gLsPBdrNkhAb', 'https://www.facebook.com/lequocdat2076/posts/201680741657602', 'tang-like-facebook', '[ Lên sau 40p ] + [ Nhập Link ] - [ Nhập id không chạy được ] - [ Không chạy cho group + bài share ]', 'admin1', '4000', '0', '0', '16000', 'Waiting', '', '', '1631881373'),
(54, 'UBS9GZnJW4y7', 'https://www.facebook.com/lequocdat2076/posts/201680741657602', 'tang-like-facebook', '[ Lên sau 40p ] + [ Nhập Link ] - [ Nhập id không chạy được ] - [ Không chạy cho group + bài share ]', 'admin1', '1000', '0', '0', '4000', 'Waiting', '', '', '1631881714');
...
(14, '<p>TRANG WEBSITE ĐANG DẦN HOÀN THIỆN</p>\n\n<p>MỌI VẤN ĐỀ CHI TIẾT LIÊN HỆ - Zalo: 0329.005.203</p>\n\n<p>Fb:&nbsp;https://www.facebook.com/imphat2k6</p>\n', 'show', '1631454918');
...
(12, 'Facebook Buff', 'facebook-buff', 'data/3f3b79d6e73a88fca804b77b0a667529.png', '<p>.</p>\n', 'show'),
(13, 'TikTok Buff', 'tiktok-buff', 'data/43f68cb040ef70ead01d1e5a6aa0b4a3.png', '<p>.</p>\n', 'show'),
(14, 'Youtube Buff', 'youtube-buff', 'data/9e87e1cccab605dbfaf05ba1734c2582.png', '<p>.</p>\n', 'show'),
(15, 'Instagram Buff', 'instagram-buff', 'data/c6da620537323f4f8bd41c3ddf23779f.png', '<p>..</p>\n', 'show'),
...
(39, 'tang-like-page-facebook', 'Tăng Like Fage facebook', 'facebook-buff', 'data/4dffe10d45d987e35323a1c1c256461b.png', 'show'),
...
(49, 'tang-binh-luan-instagram', 'Tăng Comment Instagram', 'instagram-buff', 'data/29ce25885ac38ac6507cafcebf66f224.png', 'show'),
(50, 'tang-follow-instagram', 'Tăng Follow Instagram', 'instagram-buff', '  data/bb1bfcda5c5ffb6872cd313bd80ba3dc.png', 'show'),
(51, 'tang-theo-doi-shopee', 'Tăng theo dõi shopee', 'shopee-buff', 'https://lequocdat.com/data/b64b39dcced7f111cda31c1505bf8a60.png', 'show'),
(52, 'tang-view-san-pham', 'Tăng view sản phẩm', 'shopee-buff', 'https://lequocdat.com/data/fbe8af8324acb0fcbf62c7b18c241165.png', 'show'),
(53, 'tang-danh-gia-don-hang', 'Tăng đánh giá đơn hàng', 'shopee-buff', 'https://lequocdat.com/data/9be389601e37c6519f7af6e65520eb57.png', 'show'),
(55, 'tang-danh-gia-lazadamall', 'Tăng đánh giá lazadamall', 'lazada-buff', 'https://lequocdat.com/data/4e9947ec0e302915139fde2fe580ed03.jpg', 'show'),
(56, 'ma-giam-gia-lazada', 'Mã giảm giá lazada', 'lazada-buff', 'https://lequocdat.com/data/3223020aeb5fe47676eb27c82a5dde5a.png', 'show');
